  ...
  return (
    <>
      ...
      <div
        ...
        id="Contact"
      >
        <div className="container px-[1%] max-w-4xl grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Email Form */}
          <div
            data-aos="fade-right"
          ...
          >
            ...
            <form
              action="https://formsubmit.co/shyam.manohar1807@gmail.com" 
              method="POST"
          ...
          {/* Social Links */}
          <div
            className="bg-white/5 backdrop-blur-xl rounded-3xl p-5 sm:p-10 shadow-2xl transform transition-all duration-300 hover:shadow-[#6366f1]/10 flex items-center justify-center"
            data-aos="fade-left"
            data-aos-duration="1200"
          >
            <SocialLinks />
